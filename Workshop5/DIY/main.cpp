...
void BinaryOperators()
{
     ...
     cout << endl
          << "Binary Member operator tests" << endl;
     ...
     cout << "---------------------------------------------" << endl;
     cout << endl
          << "Binary non-member operator test" << endl;
...
void typeConversionTest()
{
     Bus bus[] = {
         ...
         {42}};
     cout << endl
          << "Type Conversion operator tests" << endl;
     for (int i = 0; i < 3; i++)
     {
          cout.setf(ios::fixed);
          cout.precision(2);
          if (bus[i])
          {
               ...
               cout << double(bus[i]) << " Dollars total fare." << endl
                    << "---------------" << endl;
          }
          else
          {
...
{
     cout << endl
          << "Operator <<, Operator >>, display and read test" << endl;
     Bus bus[] = {
         {},
         {25},
         {20, 25},
     ...
     cout << "Enter the following valid values:" << endl
          << " 22,11" << endl
          << ">";
     cin >> bus[0];
     cout << bus[0] << "----------" << endl;
     ...
     cin >> bus[0];
     cout << bus[0] << "----------" << endl;
     cout << "Enter the following invalid values:" << endl
          << " 44,20" << endl
          << ">";
     cin >> bus[0];
     cout << bus[0] << "----------" << endl;
