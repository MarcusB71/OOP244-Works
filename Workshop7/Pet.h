...
namespace sdds
{
    class Pet
    {
        const double COST_BASE = 1.00;		// Pet Fee: Initial purchase
        const double COST_FEED = 0.00;		// Pet Fee: For each feeding
        const double COST_REVIVE = 0.25;		// Pet Fee: Respawn if perished
